...
MEDICAL_DICT = {
    ...
    "paracetamol": {
        "ipa": "/ˌpærəˈsiːtəmɒl/",
        "simplified": "pa-ra-SEE-ta-mol",
        "syllables": ["pa", "ra", "SEE", "ta", "mol"],
        "stress": [3],
        "category": "drug",
    },
    "panadol": {
        "ipa": "/ˈpænədɒl/",
        "simplified": "PAN-a-dol",
        "syllables": ["PAN", "a", "dol"],
        "stress": [1],
        "category": "drug",
    },
    ...
    "artemisinin": {
        "ipa": "/ˌɑːrtɪˈmɪsɪnɪn/",
        "simplified": "ar-te-MIS-i-nin",
        "syllables": ["ar", "te", "MIS", "i", "nin"],
        "stress": [3],
        "category": "drug",
    },
    "chloroquine": {
        "ipa": "/ˈklɔːrəkwiːn/",
        "simplified": "KLOR-o-kween",
        "syllables": ["KLOR", "o", "kween"],
        "stress": [1],
        "category": "drug",
    },
    "malaria": {
        "ipa": "/məˈlɛəriə/",
        "simplified": "ma-LAIR-ee-a",
        "syllables": ["ma", "LAIR", "ee", "a"],
        "stress": [2],
        "category": "condition",
    },
    "tuberculosis": {
        "ipa": "/tjuːˌbɜːrkjʊˈloʊsɪs/",
        "simplified": "too-BUR-kyu-LOH-sis",
        "syllables": ["too", "BUR", "kyu", "LOH", "sis"],
        "stress": [2, 4],
        "category": "condition",
    },
    "typhoid": {
    ...
    "hepatitis": {
        "ipa": "/ˌhɛpəˈtaɪtɪs/",
        "simplified": "HEP-a-TY-tis",
        "syllables": ["HEP", "a", "TY", "tis"],
        "stress": [1, 3],
        "category": "condition",
    },
    "meningitis": {
        "ipa": "/ˌmɛnɪnˈdʒaɪtɪs/",
        "simplified": "MEN-in-JY-tis",
        "syllables": ["MEN", "in", "JY", "tis"],
        "stress": [1, 3],
        "category": "condition",
    },
    "jaundice": {
